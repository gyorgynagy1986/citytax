        ...
        <section className="adatvedelem">
          <div className="process_main-head policy-margin">
            ...
            <ul className="policy-txt mb-20">
              <li className="off-text-selection">
                Az adatkezelő megnevezése: City Tax Kft.
              </li>
              <li className="off-text-selection">
                Az adatkezelő elérhetősége: 6900 Makó, Móricz Zsigmond utca 8.
              </li>
              <li className="off-text-selection">
                email: info@citytax.hu{" "}
              </li>
              <li className="off-text-selection">Telefon: 06-30/799-3615</li>
              <li className="off-text-selection">Adószám : 23005305-2-06</li>
            </ul>
          </div>
          <div className="process_main-head policy-margin">
          ...
          <div className="process_main-head policy-margin">
            ...
            <p className="policy-txt">
              ...
              látogató neve, e-mail címe, telefonszáma és üzenete.
            </p>
          </div>
          <div className="process_main-head policy-margin">
          ...
          <div className="process_main-head policy-margin">
            ...
            <p className="policy-txt">
              ...
              keresztül érkező üzenetekre és kapcsolattartásra. A
          ...
          <div className="process_main-head policy-margin">
            ...
            <p className="policy-txt">
              ...
              adatot (név, e-mail cím, telefonszám) 3 hónapon belül véglegesen
              törlünk.
            </p>
          </div>
          <div className="process_main-head policy-margin">
